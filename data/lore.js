  ...
  "nations": {
    ...
    "snowfals": {
      ...
      "tabs": {
        ...
        "religions": [
          ...
          "The bedrock is Mostal, the Sacred, lord of balance and named by many the maker of the world. His is an old faith of harmony, far older than the Republic itself: the belief that all things must be kept in order, less in any direction breeds ruin, and that whatever does not give rise to evil is owed respect. Its practioners tolerate other gods readily, judging them by their fruits rather than their doctrine, and are disciplined to waste nothing, sanctifying all creatures great and small. Mostal's worship runs deep beneath everything the Snowfallian do, from the keeping of their accounts to the keeping of their borders.",
          "Atop that ancient ground stands the younger and louder faith: the Word of Clayard. Clayard the Blonde was, according to legend, a mortal who became a goddess - a revolutionary who rose against the Lefranthan Empire three centuries ago, led the war that won the Republic its freedom, crying a single word, 'RISE', and then vanished from the world with the victory still in her hand. From that cry came the faith, freedom through revolution, the throwing-down of tyrants, and a promised peace at the end of all the rising. It is a creed made for the moment of liberation, and the Snowfallian always remmeber her, adding to Clayard's company each generation the names of other liberators who earned a place beside her. Where Mostal teaches the Snowfallian to endure the world, Clayard teaches them when to remake it.",
    ...
    "midwel": {
      ...
      "tabs": {
        ...
        "religions": [
          ...
          "Midwel does not persecute the act of belief; it persecutes its organisation. A person may keep whatever god they like at their own hearth, and the crown will never ask - but let a congregation form or preach to a standing crowd - and the sword comes swift. The Esirianfan Church and Mostal are treated alike. A mass of people moved by one voice toward one feeling is the single thing a kingdom of lords and laws cannot abide, whatever they happen to be chanting. Faith in Midwel is mute. House Black's worship of Mostal remains behind laboratory doors. The Word of Clayard, the revolutionary goddess who bids the conquered rise against their masters, has spread into Midwel from the north - and a creed whose central act is revolution - is the faith most fiercely broken whenever it dares to gather, and the faith with the most reason to gather regardless.",
          "By forbidding religious gatherings, it raised two slow problems in its place. Its sciences keep reaching, generation by generation, toward arcane forces older and stranger than the rational mind is ready to understand. And beneath its calm, governed surface, a banned god of revolution gathers strength in cellars and backalleys among people who were never argued out of belief, only forbidden to share it aloud."
        ],
        "life": ["Lefrantha is a powerful empire..."],
        "people": ["Lefrantha is a powerful empire..."],
        "champions": ["Lefrantha is a powerful empire..."]
    ...
    "nog": {
      ...
      "tabs": {
        ...
        "religions": [
          "The Nogruk believe, above all else, in never yielding. Its faith is Vrarudism, the creed of Ulzugnud the Unyielding, preaching that weakness is death and the past must be forgotten. A hard forward-driving doctrine for a hard, forward-driving nation ask for a refusal to stop. Ulzugnud, the conqueror-prophet forged the kingdom out of brutal war. His teaching is austere and pitiless. Destruction of the weak and the old is a necessary step to rebirth. The faith is kept through ritual dedications, formal oaths and trials by which a Nogruk binds themselves to the path of perseverance. To yield is the only true sin. To endure is righteous.",
          "The Nogruk are an orcish people descended from Grug, and Vrarudism's founding act was to reject it. In the kingdom's making, the old beliefs were branded the cause of every shame the people had ever suffered, and those who clung to them were purged in their first victory. A faith that began by erasing its own past does not flinch at remaking anything else. Lived out, Vrarudism is as much a way of ruling as a way of believing. The courts of Nog runs on its logic precisely: a nest of ambitious factions in which weakness is fatal, success must be seized and held, and failures are cut out. It makes the Nogruk formidable, forever driving toward the next conquest because the doctrine recognises no point at which striving is permitted to stop.",
          "Beneath the creed runs an older faith that Vrarudism has never managed to cull, the Khuld naval tradition. The Nogruk live and die at sea, and sailors are not easily argued out of their gods - so sea-spirits and the worship of great dead raiders persist on every deck. To the strict Vrarudist it is superstition, a softness fit for purging. To the people who actually crew the longships through the brutal seas of the far south, it is the only faith that has ever reliably answered when called. The kingdom's grand ambition has made an ally with the truth of the ocean it depends on."
        ],
        "life": ["Lefrantha is a powerful empire..."],
        "people": ["Lefrantha is a powerful empire..."],
        "champions": ["Lefrantha is a powerful empire..."]
    ...
    "grug": {
      ...
      "tabs": {
        ...
        "environments": [
          ...
          "The land itself is mostly made up of dense forest that choke its river-valleys, broken only by stretches of black bog and the vast tundra. The forest is where their shrines stand and their ordeals are kept. Settlements sit in clearings hacked from the gloom.",
        ...
        "religions": [
          ...
          "The doctrine is bleak and absolute. Comfort is a poison; mercy is a cruelty done to the weak; and the only road to strength, meaning, and Ar-Nard runs straight through one's own broken body. A child of Grug is seeks pain instinctively, and grows with its relationship to its own flesh turned inside out, so that by adulthood a true devotee feels the lash as warmth, the brand as clarity, the breaking of a bone as joy. This is the thing that diplomats cannot force their minds around - the people of Grug have detached themselves from what the rest of the world consider mortal. They lean into agony, smiling, because Ar-Nard is waiting, and the strength he gives them is measured exactly by how much you were willing to give.",
          "The faith is kept by its pain-priests who remake themselves, year upon year, with blade and hook, until their bodies are monuments to their own devotion - flesh scarred past recogition, skin studded with metal, joints deliberately broken such that every movement is painful. Rank is read off the body: the highest painpriests are barely men any longer, scarcely able to stand, held upright by faith and iron frame, and venerated precisely because of it. Worship is constant and physical. The faithful open their own backs in prayer, take the brand for every vow and grief, and gather on holy days for trials that would simply kill anyone else - flesh sewn and torn and sewn again, fire walked barefoot, days spent hanging from hooks driven through living muscle. Before a Grug warrior goes to war, they wound themselves first, to call up the strength that only fresh agony unlocks. They march into battle already bleeding. There is nothing an enemy can do to them that they have not already done worse to themselves.",
          "At the summit of all devotion stand the Impentinent, and even by Grug's measure they are a horror. Unshackled by mortality, the Impentinent are creatures of perpetual suffering - devotees bound forever in cages of fire, iron, and barbs - and to be chosen is the single highest honour the faith can grant. The blessed go in willingly, weeping with gratitude, to be welded into a frame that will torture them without pause until the day they die, channelling that endless screaming agony into a strength no unbroken body could ever produce. A smoking, shrieking thing of metal and ruined flesh that Grug granted sainthood, to be venerated and aspired to by its people.",
